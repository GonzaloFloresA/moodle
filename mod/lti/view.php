...
if ( $launchcontainer == LTI_LAUNCH_CONTAINER_WINDOW ) {
    ...
    echo '<iframe id="contentframe2" height="600px" width="100%" src="http://localhost/moodle/mod/lti/1.php"></iframe>';
    

    // Output script to make the iframe tag be as large as possible.http://localhost:3000/Provider/create/client
    $resize = '     
        ...
        //<![CDATA[
            YUI().use("node", "event", function(Y) {
                ...
                var frame2 = Y.one("#contentframe");
                var padding2 = 100; //The bottom of the iframe wasn\'t visible on some themes. Probably because of border widths, etc.
                var lastHeight2;
                var resize2 = function(e) {
                    var viewportHeight2 = doc.get("winHeight");
                    if(lastHeight2 !== Math.min(doc.get("docHeight"), viewportHeight2)){
                        frame2.setStyle("height", viewportHeight2 - frame2.getY() - padding2 + "px");
                        lastHeight2 = Math.min(doc.get("docHeight"), doc.get("winHeight"));
                    }
                };
